...
<form method="post" action="konfirm.php" enctype="multipart/form-data" onsubmit="MM_validateForm('contact','','R','phone','','R','email','','R','order','','RisNum','address','','R');return document.MM_returnValue">
      ...
      <tr>
        ...
        <td valign="top" bgcolor="#FFFBCA"><table width="638" align="center">
            ...
            <tr bgcolor="#FFFBCA">
              ...
              <td width="140"><strong>Adapter<br />
            ...
            <table width="747">
              ...
              <tr>
                ...
                <td width="258">: 
                  ...
                  <input name="company" type="text" id="company" maxlength="30" />                  </td>
              ...
              <td><div align="left">: 
                    ...
                    <textarea name="address" cols="25" rows="4" id="address"></textarea>
              ...
              <tr>
                ...
                <td>: 
                  ...
                  <input name="order" type="text" id="order" onchange="MM_validateForm('order','','NisNum');return document.MM_returnValue" size="7" />
...
<!--Modify by EA -->  
                ...
                <td><div align="center"><input type="radio" name="sampel" value=1 id="sample1" />
                <img src="sampel design1.jpg" width="160" height="88" /></div></td>
                <td><div align="center"><input type="radio" name="sampel" value=2 id="sample2" />
                <img src="sampel design2.jpg" width="160" height="88" /></div></td>
                <td><div align="center"><input type="radio"  name="sampel" value=3 id="sample3" />
                <img src="sampel design3.jpg" width="160" height="88" /></div></td>
                ...
                <td><div align="center"> 
                   <img src="sampel_teks.jpg" width="250" height="84" /> <td> 
                   <textarea name="entri_teks" cols="30" rows="5" id="entri_teks"></textarea></td>
                   <td>  <span class="style3"> *Harap diisi bila memilih salah satu dari ketiga sampel.</span> </div> </td>
                </tr>   
                    
<!-- ini batas modify <div align="left"> -->                   
              ...
              <tr>
                ...
                <input type="submit" name="Submit" value="pesan" /></td>
